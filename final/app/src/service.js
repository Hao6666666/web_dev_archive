...
export function fetchAddComment(id, comment) {
...
export function fetchGetComment(id) {
  return fetch(`/api/post/${id}/comment`, { method: "GET" })
    .catch(() => Promise.reject({ error: "networkError" }))
    .then((response) => {
      if (response.ok) {
        return response.json();
...
export function fetchGetLike(id) {
  return fetch(`/api/post/${id}/like`, { method: "GET" })
    .catch(() => Promise.reject({ error: "networkError" }))
    .then((response) => {
      if (response.ok) {
        return response.json();
